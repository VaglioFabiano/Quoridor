...
//dichiara le funzioni nuove qui
void StartMessage(void);
void chest(void); 
void DrawSquare(uint16_t x1,uint16_t y1,uint16_t x2,uint16_t y2, uint16_t color);
void DrawSolidSquare(uint16_t x1,uint16_t y1,uint16_t x2,uint16_t y2, uint16_t color);
void DrawPawn(uint16_t coordx,uint16_t coordy,uint16_t color);
void DrawVWall(uint16_t coordx, uint16_t  coordy, uint16_t color);
void DrawOWall(uint16_t coordx, uint16_t  coordy, uint16_t color);
void LowerPart(void);
